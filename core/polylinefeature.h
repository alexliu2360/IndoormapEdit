#ifndef POLYLINEFEATURE_H
#define POLYLINEFEATURE_H
#include <QGraphicsObject>
#include <QJsonObject>
#include<QPointF>
class PolylineFeature : public QGraphicsObject
{
    Q_OBJECT
...
public:
    explicit PolylineFeature(QGraphicsItem *parent = 0);
    explicit PolylineFeature(const QString & name, QGraphicsItem *parent = 0);
